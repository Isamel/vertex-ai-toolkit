...
def build_file_filter(settings: Settings, root_dir: Path) -> pathspec.PathSpec:  # type: ignore[type-arg,unused-ignore]
...
def should_include_file(
    ...
    *,
    settings: Settings,
    spec: pathspec.PathSpec,  # type: ignore[type-arg,unused-ignore]
    root_dir: Path,
) -> bool:
