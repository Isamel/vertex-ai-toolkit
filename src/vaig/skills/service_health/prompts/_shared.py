...
3. While Kubernetes health is the primary signal, APM metrics with CRITICAL or HIGH severity (per the analyzer's APM thresholds) generate independent findings that MUST be reported — even when K8s shows healthy pods.
