"""Integration tests for the Compliance Check skill gatherer agent.
...
class TestComplianceCheckGathererAgent:
    """Gatherer agent wiring tests for ComplianceCheckSkill."""
    ...
    def test_gatherer_is_first_agent(self) -> None:
        ...
        assert agents[0]["name"] == "compliance_gatherer"
    ...
    def test_gatherer_prompt_starts_with_anti_injection(self) -> None:
        from vaig.skills.compliance_check.prompts import (
            ANTI_INJECTION_RULE,
            COMPLIANCE_GATHERER_PROMPT,
        )

        assert COMPLIANCE_GATHERER_PROMPT.startswith(ANTI_INJECTION_RULE)
    ...
    def test_gatherer_max_iterations_is_twelve(self) -> None:
        from vaig.skills.compliance_check.skill import ComplianceCheckSkill
...
class TestComplianceCheckSkillLiveToolsMetadata:
